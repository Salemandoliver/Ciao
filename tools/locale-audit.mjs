...
// Through the product switch, or a partner/console run would store the
// marketplace's refresh key and audit a login redirect instead of the app.
await ctx.addInitScript(boot("en", refresh));
