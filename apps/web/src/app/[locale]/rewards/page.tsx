...
const copy = {
  ar: {
    ...
    earn: {
      ...
      birth_date_added: "إضافة تاريخ ميلادك",
      party_profile_added: "إخبارنا بمن يسافر معك عادة",
      birthday_gift: "هدية عيد ميلادك — كل سنة، تلقائيًا",
  ...
  en: {
    ...
    earn: {
      ...
      birth_date_added: "Adding your date of birth",
      party_profile_added: "Telling us who usually travels with you",
      birthday_gift: "Your birthday gift — every year, automatically",
    } as Record<string, string>,
    earnNote:
